...
function www2_scripts() {
  ...
  wp_enqueue_script( 'modernizr', get_template_directory_uri() . '/js/modernizr.custom.55862.js', null, '20130214', true );
  wp_enqueue_script( 'scripts', get_template_directory_uri() . '/js/scripts.js', array( 'jquery', 'modernizr' ), '20120206', true );
